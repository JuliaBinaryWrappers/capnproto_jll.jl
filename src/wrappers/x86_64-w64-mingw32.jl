# Autogenerated wrapper script for capnproto_jll for x86_64-w64-mingw32
...
const capnp_splitpath = ["bin", "capnp.exe"]
...
const libcapnp_splitpath = ["bin", "libcapnp-0-7-0.dll"]
...
const libcapnp = "libcapnp-0-7-0.dll"
