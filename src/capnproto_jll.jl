...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import capnproto_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3576fdfd-e245-5854-bcf7-dae6dc3117e0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "capnproto", artifacts_toml) for e in artifacts["capnproto"]]
...
if best_platform === nothing
    @debug("Unable to load capnproto; unsupported platform $(triplet(platform_key_abi()))")
else
